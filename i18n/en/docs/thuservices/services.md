...
[Introduction to Tsinghua University Campus Network](https://its.tsinghua.edu.cn/helpsystem/train/CampusNetworkLectureNotes201909.pdf) (Link broken due to website upgrade; see our [backup](file/CampusNetworkLectureNotes201909.pdf))

[Network Access Authentication Instructions](http://166.111.5.8/commsoft/helpsystem/wirednetwork/RealNameAuthentication20190121.pdf) (Our [backup](file/RealNameAuthentication20190121.pdf))

[Tsinghua University Campus Wired LAN User Authentication System FAQ](https://its.tsinghua.edu.cn/helpsystem/wirednetwork/RealNameAuthenticationFAQ20190614.pdf) (Link broken due to website upgrade; see our [backup](file/RealNameAuthenticationFAQ20190614.pdf))
...
After setting up, you can use `NetworkManager` to connect to this WiFi. Refer to the ITS documentation [Tsinghua University Wireless Campus Network 802.1x Authentication Login Client Configuration Guide](https://its.tsinghua.edu.cn/info/1333/2318.htm) (Our [backup](file/tsinghua-secure-config.pdf)).
