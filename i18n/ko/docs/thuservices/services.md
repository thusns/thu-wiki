...
[清华大学校园网使用简介](https://its.tsinghua.edu.cn/helpsystem/train/CampusNetworkLectureNotes201909.pdf) (웹페이지 업그레이드 링크가 만료되었으므로 본 사이트의 [备份](file/CampusNetworkLectureNotes201909.pdf)을 참고해주세요)

[准入上网使用说明](http://166.111.5.8/commsoft/helpsystem/wirednetwork/RealNameAuthentication20190121.pdf) (이 사이트[备份](file/RealNameAuthentication20190121.pdf))

[清华大学校园网有线局域网用户准入系统使用说明（问与答）](https://its.tsinghua.edu.cn/helpsystem/wirednetwork/RealNameAuthenticationFAQ20190614.pdf) (웹페이지 업그레이드 링크가 만료되었으므로 본 사이트의 [备份](file/RealNameAuthenticationFAQ20190614.pdf)을 참고해주세요)
...
설정 후 `NetworkManager`을(를) 사용하여 Wi-Fi에 연결할 수 있습니다. 문서 [清华大学无线校园网 802.1x 认证登录客户端配置说明](https://its.tsinghua.edu.cn/info/1333/2318.htm)(이 사이트 [备份](file/tsinghua-secure-config.pdf))을 참조할 수 있습니다.
